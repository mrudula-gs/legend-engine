...
public class DeephavenJavaCompilerExtension implements ExecutionPlanJavaCompilerExtension
{
    ...
    static
    {
        DEPENDENCIES.put("io.deephaven.client.impl.BarrageSession", BarrageSession.class);// can we remove io.deephaven
        ...
        DEPENDENCIES.put("io.deephaven.qst.table.LabeledTable", LabeledTable.class);


        DEPENDENCIES.put("io.deephaven.api.filter.Filter", Filter.class);

        DEPENDENCIES.put("io.deephaven.client.impl.ApplicationService", ApplicationService.class); // do we need all these ?
