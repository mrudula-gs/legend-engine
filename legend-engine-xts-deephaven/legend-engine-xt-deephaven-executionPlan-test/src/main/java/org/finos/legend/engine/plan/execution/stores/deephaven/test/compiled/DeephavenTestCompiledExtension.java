...
import org.finos.legend.engine.plan.execution.stores.deephaven.test.compiled.GetDeephavenTestConnection;
...
public class DeephavenTestCompiledExtension extends BaseCompiledExtension
{
    public DeephavenTestCompiledExtension()
    {
        super(
                "core_deephaven_pure",
                () -> Lists.fixedSize.with(new GetDeephavenTestConnection()),
