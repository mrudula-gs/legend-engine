...
public class TestExtensionAvailable
{
    ...
    public void testServiceAvailable()
    {
        ...
        Assert.assertEquals(2, extensions.selectInstancesOf(DeephavenLegendPureCoreExtension.class).get(0).extraPureCoreExtensions(PureModel.getCorePureModel().getExecutionSupport()).size());
